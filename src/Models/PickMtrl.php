...
namespace PcbEms\PcbKingdee\Models;

use PcbEms\PcbKingdee\Contracts\BillModel;

class PickMtrl extends AbstractBillModel implements BillModel
{
    const FORM_NAME = 'PRD_PickMtrl';
    ...
    protected static $entryMappings = [
        ...
        [
            'attribute' => 'base_actual_qty',
            'column' => 'FBaseActualQty',
            'field' => 'FBaseActualQty',
            'comment' => '基本单位实发数量',
        ],
        [
